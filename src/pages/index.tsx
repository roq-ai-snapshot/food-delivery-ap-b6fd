  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Food Delivery App - Transforming the way you order food, bringing your favorite meals to your doorstep with our innovative SaaS solution."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1695653420013-47c8e156e0af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxmb29kJTIwZGVsaXZlcnl8ZW58MHx8fHwxNjk3Njc1NzcxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Food Delivery App - Transforming the way you order food, bringing your favorite meals to your doorstep with our innovative SaaS solution.`}
            </Text>
            <Box
